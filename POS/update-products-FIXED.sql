-- PRODUCTOS CANASTA FAMILIAR - VERSION ULTRA SIMPLE
...
ALTER SEQUENCE products.categories_id_seq RESTART WITH 1;
ALTER SEQUENCE products.products_id_seq RESTART WITH 1;

-- Insertar categorías (IDs serán 1-9)
INSERT INTO products.categories (name, description) VALUES
('Lácteos', 'Productos lácteos y derivados'),        -- ID 1
('Panadería', 'Pan y productos de panadería'),        -- ID 2
('Bebidas', 'Bebidas y jugos'),                       -- ID 3
('Granos', 'Arroz, fríjoles y cereales'),             -- ID 4
('Aceites', 'Aceites de cocina'),                     -- ID 5
('Condimentos', 'Sal, azúcar y condimentos'),         -- ID 6
('Aseo', 'Productos de aseo e higiene'),              -- ID 7
('Snacks', 'Mecatos y snacks'),                       -- ID 8
('Carnes', 'Carnes y proteínas');                     -- ID 9

-- Insertar productos con category_id fijo (ahora coincidirán)
...
-- ASEO (category_id = 7)
('JABON-REY-3PACK', 'Jabón Rey x3', 'Jabón de tocador pack x3', 7, 6500.00, 80, '7703215678901', 0.19, true),
